    ...
    () => {
      setMenuClass(
        toggle
          ...
          : "transition-opacity ease-in-out duation-300 transfor, -translate-y-full opacity-0"
      );
    },
    { toggle }
  );
    ...
    <section className="w-full bg-black text-white flex justify-between items-center px-8 py-6 lg:px-16 sticky top-0 z-40">
      ...
      <div className="hidden lg:flex justify-end items-center gap-2">
        <ul className="flex justify-center items-center gap-3">
          <li>
            <a
              className="text-lg text-slate-100 cursor-pointer rounded-rm px-5 py-2 hover:bg-green-600 hover:text-white active:text-white"
              href="/"
            >
              HOME
            </a>
        ...
        {toggle && (
          ...
          >
            <ul className="flex flex-col justify-center items-center gap-2">
              <li className="text-xl text-white font-semibold hover:bg-green-500 hover:text-white w-full items-center">
                Home
              </li>
            </ul>
          </div>
